 ...
 */
import type { ForecastForecastdayItemHourItemCondition } from "./forecastForecastdayItemHourItemCondition";

export type ForecastForecastdayItemHourItem = {
  time_epoch?: number;
  time?: string;
  temp_c?: number;
  temp_f?: number;
  is_day?: number;
  condition?: ForecastForecastdayItemHourItemCondition;
  wind_mph?: number;
  wind_kph?: number;
  wind_degree?: number;
  wind_dir?: string;

 ...
 */
import type { MarineForecastdayItemHourItemCondition } from "./marineForecastdayItemHourItemCondition";

export type MarineForecastdayItemHourItem = {
  time_epoch?: number;
  time?: string;
  temp_c?: number;
  temp_f?: number;
  is_day?: number;
  condition?: MarineForecastdayItemHourItemCondition;
  wind_mph?: number;
  wind_kph?: number;
  wind_degree?: number;
  wind_dir?: string;
